defmodule PostingImageWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PostingImageWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PostingImageWeb.Gettext, "errors", msg, opts)
    end
  end
